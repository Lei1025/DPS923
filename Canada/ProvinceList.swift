...
class ProvinceList: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func configureCell(cell: UITableViewCell, atIndexPath indexPath: NSIndexPath) {
        ...
        cell.textLabel!.text = item.valueForKey("provinceName")! as? String
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "toProvinceDetail" {
            ...
            // Pass on the object
            vc.detailItem = item as? Province
            
            // Configure the view if you wish
            vc.title = item.valueForKey("provinceName") as? String
        }
    }
