...
class Launch: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        else if segue.identifier == "toVenueList" {
    ...
    func checkForDataOnDevice() {
        ...
        if model.frc_sport.fetchedObjects?.count == 0 {
            ...
            NSNotificationCenter.defaultCenter().addObserver(self, selector: "fetchCompletedSports", name: "Launch_sports_fetch_completed", object: nil)
    ...
    func fetchCompletedSports() {
        ...
        // First, listen for the notification (from the WebServiceRequest instance)
        // that indicates that the download is complete
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "fetchCompletedVenues", name: "Launch_venues_fetch_completed", object: nil)
    ...
    func fetchCompletedVenues() {
        ...
        for s in sports {
            ...
            let d = model.addNew("Sport") as Sport
        ...
        for v in venues {
            ...
            let d = model.addNew("Venue") as Venue
